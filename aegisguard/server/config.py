"""
AegisGuard – Server Configuration (Pydantic Settings)
...
class Settings(BaseSettings):
    model_config = SettingsConfigDict(
        env_file=("/etc/aegisguard/aegisguard.env", "/etc/aegisguard/db.env", ".env"),
    ...
    aegis_log_dir: str            = Field("/var/log/aegisguard", alias="AEGIS_LOG_DIR")

    # Data directories
    aegis_data_dir: str           = Field("/var/lib/aegisguard", alias="AEGIS_DATA_DIR")
    ...
    smtp_from: str                = Field("aegisguard@localhost", alias="SMTP_FROM")
