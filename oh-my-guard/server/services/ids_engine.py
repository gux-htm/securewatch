"""
Oh-My-Guard! – IDS/IPS Packet Inspection Engine
Uses Scapy for packet capture + netfilterqueue (Linux) for inline prevention (IPS mode).

Runs as a separate process (Oh-My-Guard!-ids systemd service / Windows service).
...
IDS_CHANNEL = "Oh-My-Guard!:ids:alerts"
...
def main():
    ...
    import argparse
    parser = argparse.ArgumentParser(description="Oh-My-Guard! IDS/IPS Engine")
