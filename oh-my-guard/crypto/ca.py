"""
Oh-My-Guard! – Internal Certificate Authority (CA)
...
def _load_ca() -> tuple[x509.Certificate, RSAPrivateKey]:
    """Load the Oh-My-Guard! root CA cert and key from disk (never cached in RAM long-term)."""
...
def issue_client_cert(
    ...
    """
    Issue a new client TLS certificate signed by the Oh-My-Guard! CA.
    ...
    subject = x509.Name([
        ...
        x509.NameAttribute(NameOID.ORGANIZATION_NAME, "Oh-My-Guard!"),
